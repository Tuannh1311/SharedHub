...
"""
Crawler: collect date from brownser
Parse: transform raw data to insight data
Library: 
    selenium with python (thao tác trên web bằng coding)
    urllib: download htlm web content
    BeautifulSoup: xử lý Htm
"""
import 
